...
The `maquinista` binary is **not on the default PATH**. Always use the absolute path:

```
/home/otavio/go/bin/maquinista
```

## Rules

1. **ONLY** create tasks using: `/home/otavio/go/bin/maquinista add <title> --status draft --project $MINUANO_PROJECT [flags]`
...
3. Create tasks with `/home/otavio/go/bin/maquinista add ... --status draft`.
4. When done planning, confirm with: `/home/otavio/go/bin/maquinista tree --project $MINUANO_PROJECT`
