// Inbox page — cross-agent flat feed of pending + processing
// messages. Complements /conversations (conversation-grouped view)
// by letting the operator scan every unresolved message in one
// place without clicking into each agent.
//
